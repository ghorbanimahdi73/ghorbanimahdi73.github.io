...
- <img align='right' width='300' src='../images/proj3.png'/> ***Gaussian mixture variatioanal autoencoder for clustering and dimensionality reduction of protein folding***
...
- <img align='right' width='300' src='../images/proj4.png'/> ***GraphVAMPNet, using graph neural network and variational approach to mark processes for dynamical modeling of biomolecules***
